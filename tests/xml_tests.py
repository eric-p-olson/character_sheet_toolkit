...
from char_sheet_toolkit.fg_xml_reader import pc_xml_fromstring, \
    pc_xml_fromfile, PcElement
...
class TestXML(unittest.TestCase):
    ...
    def test_pc_data(self):
        ...
        self.assertEqual("<character><name>Jazz</name></character>", etree.tostring(char_data, encoding="unicode"))
    ...
    def test_read_xml(self):
        ...
        # pprint.pp(char_dict)
        self.assertEqual("20", char_dict['character']['abilities']['charisma']['score']['#text'])
    ...
    def test_mako_eval(self):
        ...
        mako_data = ("${name}, Str: ${abilities.strength.score} (${abilities.strength.bonus|signed}) "
    ...
    def test_mako_markdown_eval(self):
        ...
        self.assertEqual('***Cantrips.*** You know four Sorcerer cantrips', chk_markdown[251:298])

        mako_data = "${featurelist.Spellcasting.tostring(xpath='text', method='markdown')}"
        mako_rendered = mako_render_str(mako_data, char_data)
        self.assertEqual(chk_markdown, mako_rendered)

        mako_data = "${featurelist.Spellcasting.tostring('text', method='html') | markdown}"
        mako_rendered = mako_render_str(mako_data, char_data)
